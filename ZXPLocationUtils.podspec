#
#  Be sure to run `pod spec lint ZxpTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/sinzxp/ZXPLocationUtils"
  ...
  # Or just: s.author    = "ZXP"
  # s.authors            = { "ZXP" => "1107765052@qq.com" }
  # s.social_media_url   = "http://twitter.com/ZXP"
  ...
  s.source       = { :git => "https://github.com/sinzxp/ZXPLocationUtils.git", :tag => "0.0.1" }
